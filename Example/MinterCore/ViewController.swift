...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        transactionManager.transaction(hash: "Mt6e59d0ad0286c1ec3539de71eb686cad42e7c741") { transaction, _ in
        ...
        let rawTransaction = CreateCoinRawTransaction(nonce: BigUInt(4), chainId: 2, gasCoin: "MNT", name: "BELT COIN3", symbol: "BELTCOIN3", initialAmount: BigUInt(decimal: 1000 * TransactionCoinFactorDecimal)!, initialReserve: BigUInt(decimal: 100 * TransactionCoinFactorDecimal)!, reserveRatio: BigUInt(10), maxSupply: BigUInt(1_000_000))
