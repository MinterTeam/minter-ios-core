    ...
    public func commission(options: [RawTransactionTypeCommissionOption: Any] = [:]) -> Decimal {
        ...
        case .createCoin:
            ...
            if coinSymbolLettersCount <= 3 {
                ...
                return 100_000 * TransactionCoinFactorDecimal
...
open class RawTransaction: Codable, SignatureRLPEncodable {
    public struct SignatureData: Codable, RLPEncodable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            v = try values.decode(Data?.self, forKey: .v)
            s = try values.decode(Data?.self, forKey: .s)
            r = try values.decode(Data?.self, forKey: .r)
        }
        ...
        public func encode() -> Data? {
            if !signatures.isEmpty {
                guard
                    ...
                    let address = Data(hexString: multisigAddress.stripMinterHexPrefix())
                else {
                    return nil
                }
    ...
    public var gasPrice: BigUInt = .init(RawTransactionDefaultGasPrice)
    /// Coin which will be used to get commission from
    public var gasCoin: Data
    /// Transaction type
    /// - SeeAlso: https://minter-go-node.readthedocs.io/en/docs/transactions.html#types
    public var type: BigUInt = .init(1)
    ...
    /**
     ...
     - Precondition:
     - nonce value can be retreived from the Minter Network, for exmple by calling this method
     - SeeAlso: https://minter-go-node.readthedocs.io/en/docs/api.html#transaction-count
    ...
    public required init(from decoder: Decoder) throws {
        let values = try decoder.container(keyedBy: CodingKeys.self)
        nonce = try values.decode(BigUInt.self, forKey: .nonce)
        chainId = try values.decode(Int.self, forKey: .chainId)
        gasPrice = try values.decode(BigUInt.self, forKey: .gasPrice)
        gasCoin = try values.decode(Data.self, forKey: .gasCoin)
        type = try values.decode(BigUInt.self, forKey: .type)
        data = try values.decode(Data.self, forKey: .data)
        payload = try values.decode(Data.self, forKey: .payload)
        serviceData = try values.decode(Data.self, forKey: .serviceData)
        signatureType = try values.decode(BigUInt.self, forKey: .signatureType)
        signatureData = try values.decode(SignatureData.self, forKey: .signatureData)
    }
    ...
    public func encode(forSignature: Bool = false) -> Data? {
        if forSignature {
            ...
            let fields = [nonce,
                          ...
                          serviceData,
                          signatureType,
                          signatureData.encode() ?? Data()] as [Any]
            return RLP.encode(fields)
        }
    }
    ...
    public func encode() -> Data? {
        return encode(forSignature: false)
    }
}
