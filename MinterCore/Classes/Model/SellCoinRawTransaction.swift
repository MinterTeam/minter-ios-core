...
public class SellCoinRawTransaction: RawTransaction {
    ...
    {
        let encodedData = SellCoinRawTransactionData(coinFrom: coinFrom,
                                                     coinTo: coinTo,
                                                     value: value,
...
public struct SellCoinRawTransactionData: Encodable, Decodable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        coinFrom = try values.decode(String.self, forKey: .coinFrom)
        coinTo = try values.decode(String.self, forKey: .coinTo)
        value = try values.decode(BigUInt.self, forKey: .value)
        minimumValueToBuy = try values.decode(BigUInt.self, forKey: .minimumValueToBuy)
    }
