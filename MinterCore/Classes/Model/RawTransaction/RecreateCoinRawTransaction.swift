//
//  RecreateCoinRawTransaction.swift
//  MinterCore
//
...
public class RecreateCoinRawTransaction: RawTransaction {
  ...
  public convenience init(nonce: BigUInt,
    ...
    self.init(nonce: nonce,
              ...
              gasCoinId: gasCoinId,
              type: RawTransactionType.recreateCoin.BigUIntValue(),
              payload: Data(),
              serviceData: Data())
    self.data = data
  }
...
public struct RecreateCoinRawTransactionData: Encodable, Decodable {
