...
public class CreateCoinRawTransaction : RawTransaction {
	...
	public convenience init(nonce: BigUInt, gasCoin: String, data: Data) {
		...
		self.init(nonce: nonce, gasPrice: BigUInt(RawTransactionDefaultGasPrice), gasCoin: coinData, type: RawTransactionType.createCoin.BigUIntValue(), payload: Data(), serviceData: Data())
		self.data = data
	}
