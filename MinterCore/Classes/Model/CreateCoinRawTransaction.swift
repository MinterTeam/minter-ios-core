...
public struct CreateCoinRawTransactionData: Encodable, Decodable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        initialAmount = try values.decode(BigUInt.self, forKey: .initialAmount)
        initialReserve = try values.decode(BigUInt.self, forKey: .initialReserve)
        reserveRatio = try values.decode(BigUInt.self, forKey: .reserveRatio)
        maxSupply = try values.decode(BigUInt.self, forKey: .maxSupply)
    }
