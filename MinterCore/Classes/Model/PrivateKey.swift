...
public class PrivateKey {
         ...
         childIndex: UInt32 = 0)
    {
        ...
        publicKey = RawTransactionSigner.publicKey(privateKey: privateKey,
                                                   compressed: true)!
    }
    ...
    public func derive(at index: UInt32, hardened: Bool = false) throws -> PrivateKey {
        guard (0x8000_0000 & index) == 0 else {
        ...
        helper.setPrivateKey(privateKey: raw)
        ...
        return PrivateKey(privateKey: raw,
